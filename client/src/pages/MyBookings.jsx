...
const MyBookings = () => {
  ...
  return (
    <div className='py-28 md:pd-35 md-pt-32 px-4 md:px-16 lg:px-24 xl:px-32'>
      ...
      <Title title='My Booking' subTitle='Easily manage your past, current, 
      and upcoming hotel reservations in one place. plan your trips seamlessly with 
      ...
      <div className='max-w-6xl mt-8 w-full text-gray-800'>
        ...
        {bookings.map((booking) => (
          <div key={booking._id} className='grid grid-cols-1 md:grid-cols-[3fr_2fr_1fr] w-full border-b border-gray-300 py-6 first:border-t'>
            ...
            {/* -----------Date and Timings------------ */}
            <div className='flex flex-row md:items-center md:gao-12 mt-3 gap-8'>
              <div>
                <p>Check-In :</p>
